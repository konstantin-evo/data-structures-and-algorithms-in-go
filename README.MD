...
|-------------------|---------------------------------------------|-----------------------------------------------------------|
| Sum Array         | Sums all elements in an array.              | `cd 01-arrays/01-sum-array` <br> `go run main.go`         |
| Sequential Search | Performs a linear search on an array.       | `cd 01-arrays/02-sequential search` <br> `go run main.go` |
| Binary Search     | Performs a binary search on a sorted array. | `cd 01-arrays/03-binary-search` <br> `go run main.go`     |
